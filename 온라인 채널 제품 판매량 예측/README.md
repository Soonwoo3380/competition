...
| File | Description |
|------|-------------|
| `train.csv` | 제품별 일별 판매량 학습 데이터. 제품 ID, 제품 코드, 대/중/소분류, 브랜드 코드와 2022-01-01 ~ 2023-04-04 기간의 일별 판매량으로 구성되어 있습니다. |
| `product_info.csv` | 제품별 상세 특성 정보. 제품 코드와 제품특성 텍스트로 구성되어 있으며, 제품 유형, 섭취대상, 용량, 주요 성분 등 제품 설명 기반 Feature Engineering에 활용할 수 있습니다. |
| `brand_keyword_cnt.csv` | 브랜드별 일별 검색량 데이터. 3,170개 브랜드에 대한 2022-01-01 ~ 2023-04-04 기간의 검색량 지표로, 브랜드 관심도와 수요 변화를 반영하는 보조 변수로 활용할 수 있습니다. |
| `sales.csv` | 제품별 일별 판매금액 데이터. `train.csv`와 동일한 제품 ID 및 기간 구조를 가지며, 판매량뿐 아니라 매출 규모를 반영하는 보조 Feature로 활용할 수 있습니다. |
| `sample_submission.csv` | 제출 형식 예시 파일. 2023-04-05 ~ 2023-04-25 기간의 제품별 일별 판매량을 예측하여 제출합니다. |
