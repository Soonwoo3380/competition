...
> 제품 코드 중심의 판매 데이터를 실제 제품 의미와 소비 패턴 기반 Feature로 재구성하여 향후 판매량 예측 프로젝트
...
이를 통해 Baseline 대비 약 **7.2% 성능 향상**을 달성하였고,  
...
본 대회에서는 제품별 일별 판매량 예측을 위해 판매량 데이터, 제품 특성 정보, 브랜드 검색량, 판매금액 데이터가 제공되었습니다.

| File | Description |
|------|-------------|
| `train.csv` | 제품별 일별 판매량 학습 데이터. 제품 ID, 제품 코드, 대/중/소분류, 브랜드 코드와 2022-01-01 ~ 2023-04-04 기간의 일별 판매량으로 구성 |
| `product_info.csv` | 제품별 상세 특성 정보. 제품 코드와 제품특성 텍스트로 구성 |
| `brand_keyword_cnt.csv` | 브랜드별 일별 검색량 데이터. 3,170개 브랜드에 대한 2022-01-01 ~ 2023-04-04 기간의 검색량 지표 |
| `sales.csv` | 제품별 일별 판매금액 데이터. `train.csv`와 동일한 제품 ID 및 기간 구조 |
| `sample_submission.csv` | 제출 형식 예시 파일. 2023-04-05 ~ 2023-04-25 기간의 제품별 일별 판매량을 예측하여 제출 |
...
- 제품 고유 코드 수: 15,840개
- 브랜드 수: 3,170개
- 카테고리 구조: 대분류 5개, 중분류 11개, 소분류 53개
- 학습 기간: 2022-01-01 ~ 2023-04-04, 총 459일
- 예측 기간: 2023-04-05 ~ 2023-04-25, 총 21일
- 예측 대상: 제품별 일별 판매량

### Data Limitation & Feature Engineering Point

데이터의 제품명, 브랜드명, 카테고리는 익명화된 코드 형태로 제공되었기 때문에, 코드 자체만으로는 제품의 실제 의미나 사용 맥락을 파악하기 어려웠습니다.

이를 보완하기 위해 제품 코드와 제품 정보를 기반으로 실제 제품 특성을 확인하고, 제품군, 함께 사용될 가능성이 높은 제품 관계, 소비 및 재구매 주기 등을 추가 Feature로 정의했습니다.
<br/>
...
| Final Rank | 57 / 747 |
| Percentile | Top 7% |
| Improvement | 약 7.2% over Baseline |
...
![LSTM](https://img.shields.io/badge/LSTM-Time_Series_Forecasting-7952B3?style=for-the-badge)

### Modeling Features

![Sliding Window](https://img.shields.io/badge/Sliding_Window-4682B4?style=for-the-badge)
![Change Rate Features](https://img.shields.io/badge/Change_Rate_Features-2E8B57?style=for-the-badge)
![Label Encoding](https://img.shields.io/badge/Label_Encoding-696969?style=for-the-badge)
...
결과적으로 Baseline 대비 약 **7.2% 성능 향상**을 달성했으며, 최종적으로 **747팀 중 57위, 상위 약 7%**를 기록했습니다.
